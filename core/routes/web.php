...
Route::get('/about-us', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/contact-us', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/location', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/imprint', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/data-preferences', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/press', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/coming-soon', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/request-partnership', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/tickets', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/merchandise', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/ibanksy', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/prague', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/milano', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/paris', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/barcelona', [HomeController::class, 'HomePage'])->name('HomePage');
Route::get('/dubai', [HomeController::class, 'HomePage'])->name('HomePage');
