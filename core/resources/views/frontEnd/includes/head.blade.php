...
<link href="{{ URL::asset('assets/frontend/css/bootstrap.min.css?v=1') }}" rel="stylesheet"/>
...
<link href="{{ URL::asset('assets/frontend/css/nectar.css') }}" rel="stylesheet"/>
...
<meta property='og:title' content='{{$PageTitle}} {{($PageTitle =="")? Helper::GeneralSiteSettings("site_title_" . trans('backLang.boxCode')):""}}'/>
@if(@$Topic->photo_file !="")
