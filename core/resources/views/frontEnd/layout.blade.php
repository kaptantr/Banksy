...
/*if (Helper::GeneralSiteSettings("style_type")) {
    ...
    if (Helper::GeneralSiteSettings("style_bg_type") == 0) {
        ...
        $bdy_bg_color = "";
        $bdy_bg_image = "background-size: cover;background-image:url(" . URL::to('/assets/frontend/img/zemin.png') . ")";
...
<div id="spinner-overlay"><div class="cv-spinner"><span class="spinner"></span></div></div>
